...
class __TwigTemplate_7685a3da0f489e9ae7fb756a555e8f62bfbec45db967d3963b3d0c19a4e8e4f7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12)) {
            ...
            echo "\">Ready for the sweet treats</a></p>
          <p><a href=\"";
            // line 16
...
";
    ...
    {
        return array (  119 => 27,  111 => 22,  106 => 19,  100 => 16,  96 => 15,  92 => 14,  89 => 13,  87 => 12,  84 => 11,  78 => 9,  76 => 8,  73 => 7,  66 => 6,  53 => 4,  36 => 2,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            ...
            <p><a href=\"{{ path('article_list') }}\">Ready for the sweet treats</a></p>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\ransm\\Desktop\\symphart-master\\templates\\security\\login.html.twig");
    }
}
